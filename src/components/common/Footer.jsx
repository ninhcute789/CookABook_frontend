    ...
    <footer className="bg-black py-20">
      <div className="container mx-auto px-4">
        <div className="footer-top flex pb-6 justify-center">
          <div
            className="text-white grid lg:grid-cols-3 w-full md:w-6xl
          lg:justify-between"
          >
        ...
        <div className="pb-10 mx-auto flex justify-center ">
          <div
            className="grid container text-white grid-cols-1 lg:grid-cols-4 gap-4 md:gap-10
            ...
            <div className="flex flex-col columns mb-10 lg:ml-10">
              ...
              <ul className="pl-0">
                <li className="mt-4">
                  <a
                    href="/#"
                    className="text-white opacity-50 no-underline hover:text-yellow-300 hover:translate-x-1 transition ease-in-out"
                  >
                    Điều khoản sử dụng
                  </a>
                </li>
            ...
            <div className="flex flex-col columns mb-10 max-w-2xs">
              ...
              <ul className="pl-0">
                <li className="mt-4">
                  ...
                  <p>
                    ‘Đường rộng thênh thang’: Ứng dụng triết lý Phật giáo vào
                    đời sống
                  </p>
                </li>
                <li className="mt-4">
            ...
            <div className="flex flex-col columns pl-0 lg:pl-10">
              ...
              <ul className="pl-0">
                <li className="text-white mt-4 hover:translate-x-2 transition ease-in duration-200 flex ">
                  ...
                  <a
                    href="/#"
                    className="text-white no-underline hover:text-yellow-300 flex flex-col ml-1"
                  >
                    Facebook
                  </a>
                </li>
