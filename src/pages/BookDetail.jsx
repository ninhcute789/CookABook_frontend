        ...
        <div className="bg-white">
          ...
          <ul className="space-y-1">
            ...
            <li className="flex items-start space-x-2">
              <FaCheckCircle className="text-blue-500 mt-1" />
              <span className="text-gray-800">
                Dựa trên nghiên cứu tiên tiến về tâm lý học và thần kinh học.
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <FaCheckCircle className="text-blue-500 mt-1" />
              <span className="text-gray-800">
                Cung cấp câu chuyện truyền cảm hứng từ những người thành công.
              </span>
            </li>
          </ul>
        </div>
          ...
          <div className="relative">
            ...
            <div className=" gap-4 grid grid-cols-4">
              {books.map((product) => (
                <div
                  key={product.id}
                  className=" p-3 border-1 border-gray-200 rounded-lg hover:shadow-md transition"
                >
                  <img
                    src="https://salt.tikicdn.com/cache/750x750/ts/product/5e/cd/08/7c2853c447bec11c57cb66dccb0cdd32.jpg.webp"
                    alt={product.title}
